...
export const SOUND_TYPES: Record<string, SoundPreset> = {
  ...
  strings: {
    ...
    harmonics: [
      { freqMultiplier: 1, gainMultiplier: 1, waveform: 'sawtooth' },
      { freqMultiplier: 1.002, gainMultiplier: 0.8, waveform: 'sawtooth', detune: 8 }, // slight detune for richness
  ...
  cow: {
    ...
    harmonics: [
      { freqMultiplier: 1, gainMultiplier: 1, waveform: 'sawtooth' },
      { freqMultiplier: 1.01, gainMultiplier: 0.9, waveform: 'sawtooth', detune: 10 },
  ...
  fart: {
    ...
    harmonics: [
      { freqMultiplier: 1, gainMultiplier: 1, waveform: 'sawtooth' },
      { freqMultiplier: 1.03, gainMultiplier: 0.8, waveform: 'sawtooth', detune: 15 },
  ...
  fartLong: {
    ...
    harmonics: [
      { freqMultiplier: 1, gainMultiplier: 1, waveform: 'sawtooth' },
      { freqMultiplier: 1.02, gainMultiplier: 0.9, waveform: 'sawtooth', detune: 20 },
  ...
  honk: {
    ...
    harmonics: [
      { freqMultiplier: 1, gainMultiplier: 1, waveform: 'sawtooth' },
      { freqMultiplier: 1.02, gainMultiplier: 0.8, waveform: 'sawtooth', detune: 5 },
  ...
  wobble: {
    ...
    harmonics: [
      { freqMultiplier: 1, gainMultiplier: 1, waveform: 'sine' },
      { freqMultiplier: 1.01, gainMultiplier: 0.8, waveform: 'sine', detune: 30 },
...
export const SOUNDBOARD_SOUNDS: DrumSound[] = [
  ...
  // A#4 - Splash
  {
    ...
    harmonics: [
      { freqMultiplier: 1, gainMultiplier: 0.3, waveform: 'sine' },
    ],
  ...
  // B4 - Whoosh
  {
    ...
    harmonics: [
      { freqMultiplier: 1, gainMultiplier: 0.2, waveform: 'sine' },
    ],
  ...
  // C6 - Air horn
  {
    ...
    harmonics: [
      { freqMultiplier: 1, gainMultiplier: 1, waveform: 'sawtooth' },
      { freqMultiplier: 1.02, gainMultiplier: 0.9, waveform: 'sawtooth', detune: 10 },
      { freqMultiplier: 2, gainMultiplier: 0.5, waveform: 'sawtooth' },
